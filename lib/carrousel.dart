...
final int? autoScrollValue;
 ...
 //final List String name;
  ...
  const Carrousel({Key? key,required this.imagePath, required this.selectValue, required this.autoScrollValue}):super(key: key);
        ...
        if (widget.autoScrollValue == 1) ...[
          Positioned(
            ...
            child: IconButton(
              onPressed: (){},
              icon: Icon(Icons.edit, size: 35.0),
              color: Colors.transparent, // Transparence pour l'icône d'édition
            ),
          ),
          Positioned(
            child: IconButton(
              onPressed: (){},
              icon: Icon(Icons.delete, size: 35.0),
              color: Colors.transparent, // Transparence pour l'icône de suppression
            ),
          ),
          Positioned(
            right: 5.0,
            ...
            child: IconButton(
              ...
              color: Colors.transparent, // Transparence pour l'icône de défilement
            ),
          ),
          Positioned(
            left: 5.0,
