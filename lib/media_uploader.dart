...
class MediaUploader extends StatefulWidget {
  ...
  final void Function(int) selectValueCallback; // Garder si vous en avez toujours besoin pour autre chose
...
class _MediaUploaderState extends State<MediaUploader> {
  ...
  Future<void> pickFile() async {
    try {
      ...
      if (result != null) {
        ...
        widget.imageContainerCallback(carouselProvider.images); // Maintenez ce callback si un parent en a besoin
      } else {
  ...
  Widget build(BuildContext context) {
    ...
    final autoScrollValue = carouselProvider.autoScrollValue; // Lisez directement depuis le provider
